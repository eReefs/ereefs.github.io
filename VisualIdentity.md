...
| [lode.css](./docs/assets/css/lode.css) | Applies the eReefs Visual Identity to Ontology definitions which have been rendered to HTML with [pyLODE](https://github.com/RDFLib/pyLODE) |
