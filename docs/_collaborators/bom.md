...
In the early phases of *eReefs*, the Bureau developed and hosted several operational web applications, including [ReefTemp Next Generation](/outputs/web-applications#reeftemp-next-generation) and the [eReefs Marine Water Quality Dashboard](/outputs/web-applications#marine-water-quality-dashboard).
