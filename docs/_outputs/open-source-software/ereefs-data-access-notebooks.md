...
- [Plotting data variables from eReefs model results on a map with bokeh](https://github.com/eReefs/ereefs-data-access-notebooks/blob/main/bokeh.ipynb)
- [Plotting data variables from eReefs model results on a map with matplotlib](https://github.com/eReefs/ereefs-data-access-notebooks/blob/main/plot.ipynb)
- [Plotting vector field variables from eReefs model results on a map with matplotlib](https://github.com/eReefs/ereefs-data-access-notebooks/blob/main/vectors.ipynb)
- [Clipping (subsetting) eReefs data to a region of your choice](https://github.com/eReefs/ereefs-data-access-notebooks/blob/main/clip.ipynb)
